...
public class CommandController {
    ...
    public void runCommandFromUserConsole(UserConsole.Prints prints, UserConsole.Input.InputCommand inputCommand){
        ...
        for (CommandAbstract command : commands){
            if (command.toString().equals(askedCommand.getCommandName())){
                ...
                catch (NoSuchFieldException ignore) {System.out.println("No Field");}
     ...
     */
    public void runScriptCommand(ScriptDataManager scriptDataManager) throws CommandsNotFoundException, CommandArgumentException, WorkerDataInputException {
